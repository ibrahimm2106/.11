...
public class HelloController {
    ...
    private void handleRentAction() {
        ...
        if (selectedVehicle != null) {
            ...
            if (success) notifyObservers("You rented: " + selectedVehicle);
            else showAlert("Error", "Vehicle is already rented.");
        }

        if (selectedEquipment != null) {
            boolean success = bookingManager.bookItem(selectedEquipment, currentUser);
            if (success) notifyObservers("You rented: " + selectedEquipment);
            else showAlert("Error", "Equipment is already rented.");
        }
